    ...
    public static void main(String[] args) {
        ...
        while(num > 12 || num <= 0){
            ...
            if(attepmts == 3 &&  (num > 12 || num <= 0) ){
                ...
                System.exit(0); // break koymadik.cunku koysaydik alttaki result
                //kodunu calistiracak ve error verecekti. system exit butun programi
                //durduracak ve hata vermeyecek. o yuzden exit verdik.
            }
