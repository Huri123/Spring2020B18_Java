...
public class OfferObjects {
    public static void main(String[] args) {
        ...
        offer1.setInfo("Virginia", "Bank of America", 100000, true);

        Offer offer2 = new Offer();
        offer2.setInfo("Kentucky", "Capitol One", 120000, false);
        //System.out.println(offer2.toString());toString automatically getirdigi icn boyle parantez icine yazmana gerek yok
