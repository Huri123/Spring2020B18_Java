...
public class Practice {
    ...
    public static void main(String[] args) {
       ...
       String str = "ABABABCDEF"; //["A","B","C","D","E","F"]
        ...
        System.out.println(ls); //this is array ==> [A, B, C, D, E, F]
        //ABCDEF

        String result = ""; //we assigned it String ==> ABCDEF
        for (String each : ls) {
            result += each;
        }
        ...
        str1 = new TreeSet<>( Arrays.asList(str1.split("")) ).toString();//toString ile String e convert ettik
